...
package com.example.android.listview_exam.map;

import android.os.Bundle;
import android.support.v4.app.FragmentActivity;

import com.example.android.listview_exam.R;
...
//        moveToSapporoStation();
    ...
    public void moveToSapporoStation() {
        CameraUpdate cu = CameraUpdateFactory.newLatLngZoom(new LatLng(43.0675, 141.350784), 15);
        mMap.moveCamera(cu);
    }

    public void moveToSeoulStation() {
